...
import { SaldoService } from "../service/voucherService.js";
import { VoucherClient } from "../client/voucherClient.js";

//const url = process.env.API_URL;
//let url = `http://164.152.245.77:8000/quality/concentrador_homologacao`;
const url = 'http://164.152.245.77:8000/quality/concentrador_node';
const voucherClient = new VoucherClient(url);
const saldoService = new SaldoService(voucherClient);
