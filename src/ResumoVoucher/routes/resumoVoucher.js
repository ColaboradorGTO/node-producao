...
ResumoVoucherRoutes.get('/voucher-completo', ResumoVoucherControllers.getListaVoucherCompleto)
...
ResumoVoucherRoutes.put('/todos-cliente/:id', ResumoVoucherControllers.putCliente)
...
ResumoVoucherRoutes.put('/todos-web/:id', ResumoVoucherControllers.putResumoVoucher)
