...
const atualizarFinalizarPedidoSchema = Joi.object({
    IDRESUMOPEDIDO: Joi.number().required()
        .messages({
            "number.base": "O IDCATEGORIAPEDIDO deve ser um número",
            "any.required": "O IDCATEGORIAPEDIDO é obrigatório"
        }),
    IDGRUPOEMPRESARIAL: Joi.number().required()
        .messages({
            "number.base": "O IDGRUPOEMPRESARIAL deve ser um número",
            "any.required": "O IDGRUPOEMPRESARIAL é obrigatório"
        }),
    ...
    IDCOMPRADOR: Joi.number().required()
        .messages({
            "string.base": "IDCOMPRADOR deve ser um número",
            "any.required": "O IDCOMPRADOR é obrigatório"
        }),
    IDCONDICAOPAGAMENTO: Joi.number().required()
        .messages({
            "number.base": "IDCONDICAOPAGAMENTO deve ser um número",
            "any.required": "O IDCONDICAOPAGAMENTO é obrigatório"
        }),
    IDFORNECEDOR: Joi.string().required()
        .messages({
            "string.base": "IDFORNECEDOR deve ser uma string",
            "any.required": "O IDFORNECEDOR é obrigatório"
        }),
    IDTRANSPORTADORA: Joi.number().required()
        .messages({
            "number.base": "IDTRANSPORTADORA deve ser um número",
            "any.required": "O IDTRANSPORTADORA é obrigatório"
        }),
    IDANDAMENTO: Joi.number().required()
        .messages({
            "number.base": "IDANDAMENTO deve ser um numero",
            "any.required": "O IDANDAMENTO é obrigatório"
        }),
    MODPEDIDO: Joi.string().required()
        .messages({
            "string.base": "MODPEDIDO deve ser uma string",
            "any.required": "O MODPEDIDO é obrigatório"
        }),
    NOVENDEDOR: Joi.string().required()
        .messages({
            "string.base": "NOVENDEDOR deve ser uma string",
            "any.required": "O NOVENDEDOR é obrigatório"
        }),
    EEMAILVENDEDOR: Joi.string().required()
        .messages({
            "string.base": "EEMAILVENDEDOR deve ser uma string",
            "any.required": "O EEMAILVENDEDOR é obrigatório"
        }),
    DTPEDIDO: Joi.string().required()
        .messages({
            "string.base": "DTPEDIDO deve ser uma string",
            "any.required": "O DTPEDIDO é obrigatório"
        }),
    DTPREVENTREGA: Joi.string().required()
        .messages({
            "string.base": "DTPREVENTREGA deve ser uma string",
            "any.required": "O DTPREVENTREGA é obrigatório"
        }),
    TPFRETE: Joi.string().required()
        .messages({
            "string.base": "TPFRETE deve ser uma string",
            "any.required": "O TPFRETE é obrigatório"
        }),
    DESCPERC01: Joi.number().required()
        .messages({
            "number.base": "DESCPERC01 deve ser um número",
            "any.required": "DESCPERC01 é obrigatório"
        }),
    DESCPERC02: Joi.number().required()
        .messages({
            "number.base": "DESCPERC02 deve ser um número",
            "any.required": "DESCPERC02 é obrigatório"
        }),
    DESCPERC03: Joi.number().required()
        .messages({
            "number.base": "DESCPERC03 deve ser um número",
            "any.required": "DESCPERC03 é obrigatório"
        }),
    PERCCOMISSAO: Joi.number().required()
        .messages({
...
export default atualizarFinalizarPedidoSchema;
