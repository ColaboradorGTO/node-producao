...
import vendaVendedorSchema from "../schema/alteracaoVendaVendedor.js";
...
class AdmVendasControllers {
    ...
    async putVendaVendedor(req, res) {
        try {
            const { error, value } = vendaVendedorSchema.validate(req.body, {
                abortEarly: false,
                stripUnknown: true
            });
            ...
            const response = await vendaPagamentoService.updateVendaVendedor(
                value.IDVENDEDOR,
